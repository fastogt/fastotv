...
class BuildRequest(build_utils.BuildRequest):
    ...
    def get_system_libs(self):
        ...
        if platform_name == 'linux':
            ...
            dep_libs = ['gcc', 'git', 'make', 'cmake', 'autoconf', 'automake', 'libtool', 'alsa-lib', 'ninja', 'yasm',
                        'freetype2']
...
if __name__ == "__main__":
    ...
    sdl2_image_grp.add_argument('--with-sdl2-image',
    ...
    sdl2_ttf_grp.add_argument('--with-sdl2-ttf',
